	...
	var methods = {
		init: function(e, year, month, day, period){
			...
			for(var i = 0; i < 6; i++) {
				...
				tr.append("<td class='" + daysRCalendar[i][1]['class'] + " monday'>" + daysRCalendar[i][1]['value'] + "</td>");
				tr.append("<td class='" + daysRCalendar[i][2]['class'] + " monday'>" + daysRCalendar[i][2]['value'] + "</td>");
				tr.append("<td class='" + daysRCalendar[i][3]['class'] + " monday'>" + daysRCalendar[i][3]['value'] + "</td>");
				tr.append("<td class='" + daysRCalendar[i][4]['class'] + " monday'>" + daysRCalendar[i][4]['value'] + "</td>");
				tr.append("<td class='" + daysRCalendar[i][5]['class'] + " monday'>" + daysRCalendar[i][5]['value'] + "</td>");
				tr.append("<td class='" + daysRCalendar[i][6]['class'] + " monday'>" + daysRCalendar[i][6]['value'] + "</td>");
				tr.append("<td class='" + daysRCalendar[i][0]['class'] + " monday'>" + daysRCalendar[i][0]['value'] + "</td>");
				tr.append("</tr>");
